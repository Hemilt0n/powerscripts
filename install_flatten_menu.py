...
SCRIPT_PATH = Path(__file__).parent / "flatten_folder.py"
MENU_NAME = "减少目录层级"
REG_KEY_PATH = r"Directory\shell\FlattenFolder"
...
def install_context_menu():
    ...
    try:
        ...
        winreg.SetValueEx(key, "Icon", 0, winreg.REG_SZ, "shell32.dll,46")
        winreg.CloseKey(key)
